...
你决定试一试。现在，你必须准备好递增的剑技，该如何将乱序的排列变成有序的呢？`),
  ...
  },
  {
    ...
    contents: [
      createTitle(`🗡️直面魔王`),
      createText(`让我们短暂的从激烈的战斗中抽身，好好想想该如何让数组变得有序吧！

还记得在武器店中寻找最好的剑的经历吗？

如果不记得了，也没有关系，在实战时候我们还会提醒你之前的实现方法！

现在我们只要知道，我们已经掌握了一种能够将最大的数移动到数组最后一位的方法，我们暂时不用管这个是怎么移动过去的，将它理解成一个“黑盒”即可。
...
`),
  ...
  },
  {
    ...
    contents: [
      createTitle(`🗡️直面魔王`),
      createText(`这样说肯定很难听懂吧，我们还是像之前那样，用一个简单的数组来演示吧：
| 序号 | 0 | 1 | 2 | 3 | 4 | 5 | 6 | 7 |
| :-----: | :------: | :-----: | :-----: | :-----: | :------: | :-----: | :-----: | :-----: |
| 内容 | 7 | 4 | 1 | 4 | 5 | 9 | 2 | 8 |

如果你已经理解了右边的演示，试试进入下一页，回到与魔王的战场，去破解魔王的护盾式吧！`),
    ],
  },
  {
    type: 'practice',
